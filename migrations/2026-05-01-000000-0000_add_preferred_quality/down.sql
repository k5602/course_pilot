...
INSERT INTO user_preferences_new (id, ml_boundary_enabled, cognitive_limit_minutes, right_panel_visible, onboarding_completed, right_panel_width)
SELECT id, ml_boundary_enabled, cognitive_limit_minutes, right_panel_visible, onboarding_completed, right_panel_width FROM user_preferences;
